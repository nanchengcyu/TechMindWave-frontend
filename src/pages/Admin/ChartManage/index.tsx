                          ...
                          <>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                              <div style={{ background: '#007BFF', padding: '5px 10px', borderRadius: '4px', display: 'inline-block' }}>
                                <Divider style={{ fontSize: '15px', fontWeight: 'bold', color: 'white', margin: 0 }}>{'图表标题：' + item.goal}</Divider>
                              </div>
                            </div>
                            <ReactECharts
                                option={item.genChart && isValidJson(item.genChart) ? JSON.parse(item.genChart) : null}
                            />

                            <p style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '16px',color:'#007BFF' }}>
                              {'图表名称：' + item.chartName}
                            </p>
